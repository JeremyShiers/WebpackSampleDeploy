...
/*
 these are now dynamically loaded
...
var componentRoutes = {
	...
	childRoutes: [{
		...
		getComponent: function getComponent(location, cb) {
			...
			/* 2 gotchas on cb (callback)
    * 1 first parameter is error, assume if got to then - no error
    * 2 2nd parameter is moduledefault not module
    */
		}
	}, {
		path: "artists/:id",
